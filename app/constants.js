...
export const ERROR_CODE_HASH = {
  ...
  InvalidLeaderboardSortOption: '203.M001.016',
  ...
  InvalidDefaultLeaderboardSortOption: '203.M015.002',
  InvalidLimit: [
    '203.Q002.002',
    '203.Q003.002',
    '203.Q005.002',
  ...
  LateRegistrationClosed: '204.M002.006',
  ...
  CompetitionParticipantNotFound: '204.M011.001',
  AddressHasNotConnectedToXAccount: '204.M014.002',
  CurrentOptionSameToNewOption: '204.M015.002',
  InvalidCompetitionStatus: '204.M019.001',
...
export const ERROR_MESSAGE_HASH = {
  ...
  InvalidMinimumTradingVolume: 'Invalid minimum trading volume',
  InvalidSignatureType: 'Invalid signature type',
  InvalidLeaderboardSortOption: 'Invalid leaderboard sort option',
  InvalidName: 'Invalid name',
  InvalidImageFile: 'Invalid image file',
  InvalidCompetitionParticipantIds: 'Invalid competition participant IDs',
  InvalidFile: 'Invalid file',
  InvalidDefaultLeaderboardSortOption: 'Invalid default leaderboard sort option',
  InvalidTimestamp: 'Invalid timestamp',
  InvalidStatusIds: 'Invalid status IDs',
  ...
  LateRegistrationClosed: 'Registration period has ended',
  ...
  AddressHasNotConnectedToXAccount: 'Address has not connected to X account',
  CurrentOptionSameToNewOption: 'New option must be different from current option',
  InvalidCompetitionStatus: 'Invalid competition status',
  CompetitionParticipantAddressNotFound: 'Competition participant address not found',
  FinalResultsNotFound: 'Final results not found',
