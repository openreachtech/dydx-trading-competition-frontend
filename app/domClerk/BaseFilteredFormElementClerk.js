 ...
 * @extends {BaseFormElementClerk<T, FV, SV>}
 */
export default class BaseFilteredFormElementClerk extends BaseFormElementClerk {
  /**
   ...
   */
  extractValueHash () {
    // NOTE: !! This is ad-hoc implementation to remove `disabled` elements from the
    // form. Please resolve it upstream later.
    // This is also the only difference compared to `BaseFormElementClerk`.
